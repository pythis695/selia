...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen w-screen items-center justify-center gap-4">
      <Card className="w-3/12">
        <CardHeader>
          <CardHeaderContent>
            <CardTitle>Welcome to Selia UI</CardTitle>
            <CardDescription>
        ...
        <CardBody>
          <Text>
            This section is reserved for card content. You can use it to display
            user information, <Strong>tables</Strong>,{' '}
            <Code>code snippets</Code>, or any interactive components related to
            this feature.
          </Text>
          <div className="flex gap-4 flex-wrap mt-4">
            ...
            <Button variant="invert">Open Settings</Button>
        ...
        <CardFooter>
          <Text>Yeah this is a footer.</Text>
        </CardFooter>
      </Card>
      <Card className="w-3/12">
        <CardHeader>
                ...
                <Select id="select">
                  ...
                  <SelectContent>
                    <SelectList>
                      ...
                      <SelectGroup>
                        <SelectGroupLabel>Grouped Options</SelectGroupLabel>
